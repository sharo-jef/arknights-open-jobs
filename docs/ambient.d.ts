...
declare module '$env/static/private' {
	...
	export const COMPOSE_CONVERT_WINDOWS_PATHS: string;
	...
	export const GOOGLE_API_ACCESS_TOKEN: string;
	export const GOOGLE_API_CLIENT_ID: string;
	export const GOOGLE_API_CLIENT_SECRET: string;
	export const GOOGLE_API_REFRESH_TOKEN: string;
	...
	export const npm_config_msbuild_path: string;
	...
	export const OPENCV_BIN_DIR: string;
	export const OPENCV_INCLUDE_DIR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_config_msbuild_path: string;
